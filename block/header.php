...
<div class="d-flex flex-column flex-md-row align-items-center p-3 mb-4 border-bottom">
      <a href="/" class="d-flex align-items-center text-dark text-decoration-none">
        ...
        <span class="fs-4">PHP Website</span>
      </a>
    ...
    <nav class="d-inline-flex mt-2 mt-md-0 ms-md-auto">
        ...
        <a class="me-3 py-2 text-dark text-decoration-none" href="#">Помощь</a>
        <?php if($_COOKIE ['user'] == 'yes'): ?>
            <a class="py-2 text-dark text-decoration-none" href="/auth.php">Кабинет пользователя</a>
        <?php else:?>
            <a class="py-2 text-dark text-decoration-none" href="/auth.php">Войти</a>
        <?php endif; ?>
    </nav>
</div>
</body>